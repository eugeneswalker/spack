...
#        nvptx_newlib_ver = "3.0.0.20180831"
    ...
    def copy_nvptx_tools(self):
        ...
        for file in copy_list:
            ...
            a = join_path(nvptx_tools_bin_path, fullname)
            b = join_path(gcc_bin_path, fullname)
            print("\n\nHELLO =\ncopying\n{}\n{}\n\n".format(a,b))
    ...
    def amdgcn_install(self):
        ...
        print("\n\nHELLO = copying\n{}\n\n".format(llvm_util_path))
        mkdirp(llvm_util_path)
        print("\n\nHELLO = copying\n{}\n{}\n\n".format(join_path(llvm_bin_path, "llvm-ar"), join_path(llvm_util_path, "ar")))
        copy(
            "{0}".format(join_path(llvm_bin_path, "llvm-ar")),
            "{0}".format(join_path(llvm_util_path, "ar")),
        )
        print("\n\nHELLO = copying\n{}\n{}\n\n".format(join_path(llvm_bin_path, "llvm-ar"), join_path(llvm_util_path, "ranlib")))
        copy(
            "{0}".format(join_path(llvm_bin_path, "llvm-ar")),
            "{0}".format(join_path(llvm_util_path, "ranlib")),
        )
        print("\n\nHELLO = copying\n{}\n{}\n\n".format(join_path(llvm_bin_path, "llvm-mc"), join_path(llvm_util_path, "as")))
        copy(
            "{0}".format(join_path(llvm_bin_path, "llvm-mc")),
            "{0}".format(join_path(llvm_util_path, "as")),
        )
        print("\n\nHELLO = copying\n{}\n{}\n\n".format(join_path(llvm_bin_path, "llvm-nm"), join_path(llvm_util_path, "nm")))
        copy(
            "{0}".format(join_path(llvm_bin_path, "llvm-nm")),
            "{0}".format(join_path(llvm_util_path, "nm")),
        )
        print("\n\nHELLO = copying\n{}\n{}\n\n".format(join_path(llvm_bin_path, "lld"), join_path(llvm_util_path, "ld")))
        copy(
